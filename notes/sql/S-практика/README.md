...
> - **Оверол S+A** — капстоун, собирающий всё вместе, лежит [в конце A-практики](../практика/README.md#-оверол-sa--капстоун).
>
...
Дальше → [практика A (аналитический SQL)](../практика/README.md), затем [оверол S+A](../практика/README.md#-оверол-sa--капстоун).
